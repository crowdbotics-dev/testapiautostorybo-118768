...
## Project Structure
    ...
    ├── testapiautostorybo_118768  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_118768`
...
2. Clone this repo and `cd testapiautostorybo_118768`
